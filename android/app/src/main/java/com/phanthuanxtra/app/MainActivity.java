...
public class MainActivity extends Activity {
  ...
  void build(){
    ...
    Button home=btn("⌂ Trang chủ",v->finish());Button cars=btn("Xe",v->call("GET","/cars",null,null,null));Button leads=btn("Leads",v->manageLeads());Button media=btn("Media",v->openMedia());
